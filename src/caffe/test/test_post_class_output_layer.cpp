...
class PostClassOutputLayerTest : public MultiDeviceTest<TypeParam> {
 ...
 protected:
  ...
  virtual ~PostClassOutputLayerTest() {
...
TYPED_TEST_CASE(PostClassOutputLayerTest, TestDtypesAndDevices);

TYPED_TEST(PostClassOutputLayerTest, TestSetup) {
  typedef typename TypeParam::Dtype Dtype;
...
TYPED_TEST(PostClassOutputLayerTest, TestForwardShareLocation) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  DetectionOutputParameter* detection_output_param =
      layer_param.mutable_detection_output_param();
...
TYPED_TEST(PostClassOutputLayerTest, TestForwardShareLocationTopK) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  DetectionOutputParameter* detection_output_param =
      layer_param.mutable_detection_output_param();
